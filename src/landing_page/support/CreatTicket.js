...
function CreatTicket() {
    return ( 
        <div className='container'>
            <div className='row'>
                <h1 className='fs-2 mt-2 '>To create a ticket, select a relevant topic</h1>
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Account Opening Status</a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Account Modificaton and Segment Addition</a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'> 
                    <h4 className='mb-3'><i class="fa fa-bar-chart" aria-hidden="true"></i>Your Zerodha Account</h4> 
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}} >Margin/leverage, Product and Order types</a> 
                    <br /> 
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Kite web and Mobiles</a> 
                    <br /> 
                    ...
                    <br /> 
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Stockreposts</a> 
                    <br /> 
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>GTT</a> 
                </div>

                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i class="fa fa-minus-square-o" aria-hidden="true"></i>Funds</h4>
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}} >Adding Funds</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Funds withdrawal</a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}} >Reposts</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Ledger</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Portfolio</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>60 Day Challenges</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>import</a>
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Referral Program</a>
                    <br />
                </div>
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i class="fa fa-circle-thin" aria-hidden="true"></i>Coin</h4>
                    ...
                    <br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Goverment Securities</a>
                    <br />
                </div>
            </div>
        </div>
